...
const columns: GridColDef<RequestRow>[] = [
  ...
  { field: "workbook", headerName: "Workbook / View", flex: 1, minWidth: 160 },
  {
    field: "duration",
    headerName: "Duration",
    width: 110,
  ...
  { field: "rowsScanned", headerName: "Rows Scanned", width: 130, type: "number" },
  { field: "queryType", headerName: "Query Type", width: 120 },
];

export default function RequestsTab({ rows }: { rows: RequestRow[] }) {
